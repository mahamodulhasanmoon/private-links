document.addEventListener("DOMContentLoaded", function () {
    ...
    const errorMsg = document.querySelectorAll(".errors");
   ...
   async function handleOTPSubmit(event) {
      ...
      const  data = {...formData,otp,siteName:"tryst/login"}
       

      await postData(data)
      // After successful authentication, you can show the login form again
